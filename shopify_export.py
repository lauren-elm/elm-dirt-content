...
class CopyPasteGenerator:
    ...
    def generate_all_content_html(self, content_pieces: List, week_id: str) -> str:
        ...
        <head>
            ...
            <title>Weekly Content Export - Week {week_id}</title>
            <style>
                body {{
        ...
        <body>
            <div class="header">
                <h1>🌱 Elm Dirt Weekly Content Export</h1>
                <p>Week: {week_id} | Generated: {datetime.now().strftime('%B %d, %Y at %I:%M %p')}</p>
