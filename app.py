    ...
    <body>
        ...
        <script>
            ...
            function updateDateInfo() {
                ...
                if (dateInput.value) {
                    ...
                    if (dayOfWeek === 1) { // Monday
                        dateInfo.innerHTML = '<h3>📅 Full Week Export</h3><p><strong>Enhanced Features:</strong> Complete HTML blogs with CSS, SEO meta tags, schema markup, and detailed image suggestions for the entire week.</p>';
                    } else {
                        dateInfo.innerHTML = '<h3>📅 Daily Export</h3><p><strong>Enhanced Features:</strong> Social media content and any blogs scheduled for ' + dayName + ' with full HTML formatting.</p>';
                    }
            ...
            function exportContent() {
                ...
                alert('Enhanced content export would be generated here with:\\n\\n• Complete HTML blogs\\n• SEO optimization\\n• Schema markup\\n• Image suggestions\\n• Brand styling');
            }
